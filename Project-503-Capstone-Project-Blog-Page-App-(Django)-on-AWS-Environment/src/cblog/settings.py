...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/necati/capstone/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/necati/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'necati-capstone.cd4cyawsa1n7.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'necati-aws-capstone-blog' # please enter your s3 bucket name
